...
<!-- ![タイムライン](docs/screenshots/timeline.png) -->
> 📷 `docs/screenshots/timeline.png` にスクリーンショットを配置してください
...
> 📷 `docs/screenshots/login.png` にスクリーンショットを配置してください
...
> 📷 `docs/screenshots/post_new.png` にスクリーンショットを配置してください

### 5. ソーシャル機能（いいね / ブックマーク / コメント）

投稿に対するいいね・ブックマーク・コメント機能を搭載。いいねはトレンドの順位に影響し、ブックマークは非公開の個人保存として利用できます。

<!-- ![投稿詳細](docs/screenshots/post_detail.png) -->
> 📷 `docs/screenshots/post_detail.png` にスクリーンショットを配置してください
